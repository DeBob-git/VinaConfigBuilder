...
class mainApp(QtWidgets.QMainWindow,VINAC_QT5.Ui_MainWindow):
    def __init__(self):
...
# ==================================================================================================
    ...
    def _fill_AMK_LW(self):
            ...
            if lst[0][0:4] == 'ATOM' or lst[0][0:6] == 'HETATM':
                ...
                if len(lst[0])>=6 and lst[0][0:6] == 'HETATM':
                    ...
                    if len(lst[4])>1:
                        ...
                        letter = lst[4]
                        nm =  lst[5]
                    tkatm.sname = lst[3] + ':' + letter + ':' + nm
                    tkatm.letter = lst[4]
                    tkatm.lname =  tkatm.sname
                ...
                if lst[0][0:4] == 'ATOM' and lst[3]=='UNK':
                    tkatm.tip = 'HETATM'
                    tkatm.sname=lst[3]+':A:'+lst[4]
                    tkatm.lname=lst[3]+':A:'+lst[4]
                    tkatm.X=lst[5]
                    tkatm.Y=lst[6]
                    tkatm.Z=lst[7]                      
        ...
        for key in self.atmDict:
            atmElement=self.atmDict[key]
            seen=set()
            print (atmElement[0].tip)
            if atmElement[0].tip == 'HETATM': 
                amklig=[]
                my_bsid=atmElement[0].sname
                try:
